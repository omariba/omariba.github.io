<?php
    ...
    $site_owners_email ='linton@pitt.co.ke'; /*'example@example.com'; // Replace this with your own email address */
    $site_owners_name = 'pitt.co.ke support'; /*'Example'; // replace with your name */
